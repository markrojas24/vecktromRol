...
<body background="images/golf.jpg" style="background-attachment: fixed" >
	<center><div class="tit"><h2 style="color: #0000FF; ">Sistema Vecktrom</h2>
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b style="color: #0000FF;">Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;"  type="text" name="mail"></td></tr>
		<tr><td><label style="font-size: 14pt"><b style="color: #0000FF;">Contraseña: </b></label></td>
